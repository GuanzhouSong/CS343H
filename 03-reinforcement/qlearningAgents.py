...
class QLearningAgent(ReinforcementAgent):
	...
	maxNextVal=self.computeValueFromQValues(nextState)
	sample=reward+self.discount*maxNextVal
	newQValue=(1.0-self.alpha)*oldQValue+self.alpha*sample
	self.qValues[pair]=newQValue
        #util.raiseNotDefined()
...
class ApproximateQAgent(PacmanQAgent):
	...
	for feature in features.keys():
		summ+=self.weights[feature]*features[feature]
        return summ
        #util.raiseNotDefined()
