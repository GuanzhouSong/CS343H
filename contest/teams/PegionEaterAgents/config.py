...
# Alpha-Numeric only
TeamName = 'PegionEaterAgent'

# Filename.FactoryClassName (CASE-sensitive)
AgentFactory = 'pegionEaterAgents.PegionEaterAgents'

Partners = ['Xiaohui Chen']

AgentArgs = {'first':'offense', 'second':'defense', 'rest':'offense'}

NotifyList = ['xhchen0328@utexas.edu']
