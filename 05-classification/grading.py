...
class Grades:
    ...
    def __init__(self, projectName, questionsAndMaxesList, edxOutput=False,
        muteOutput=False):
        """
    ...
    def grade(self, gradingModule, exceptionMap={}, bonusPic=False):
        ...
        for q in self.questions:
            print
            'Question %s: %d/%d' % (q, self.points[q], self.maxes[q])
        print
        '------------------'
        print
    ...
    def addMessageToEmail(self, message):
        print
        "WARNING**** addMessageToEmail is deprecated %s" % message
