...
class MiraClassifier:
    ...
    def train(self, trainingData, trainingLabels, validationData,
        ...
        return self.trainAndTune(trainingData, trainingLabels, validationData,
                                 validationLabels, Cgrid)
            ...
            for iteration in range(self.max_iterations):
                for i in range(len(trainingData)):
                    ...
                    if predictedLabel != trainingLabel:
                        tempT = ((weights[predictedLabel] - weights[
                            trainingLabel]) * trainingDatum + 1.0) / magSquareDatum
                        # print c,tempT
                        t = min(c, tempT)
